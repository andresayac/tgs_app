                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <?= $this->Html->link(__('<i class="dw dw-eye"></i>Ver'), ['action' => 'view', $role->id], [
                                        'escape' => false,
                                        'class' => 'dropdown-item'
                                    ]) ?>
                                    <?= $this->Html->link(__('<i class="dw dw-edit2"></i>Editar'), ['action' => 'edit', $role->id], [
                                        'escape' => false,
                                        'class' => 'dropdown-item'
                                    ]) ?>
                                    <?= $this->Form->postLink('<i class="dw dw-delete-3"></i>Eliminar', ['action' => 'delete', $role->id], ['class' => 'dropdown-item',  'escape' => false,'confirm' => __('Esta seguro que quiere eliminar la capacitación # {0}?', $role->id)]) ?>
                                </div>
                            </div>
                        </td>
                    </tr>
