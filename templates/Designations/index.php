                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <?= $this->Html->link(__('Ver'), ['action' => 'view', $designation->id], [
                                        'escape' => false,
                                        'class' => 'dropdown-item'
                                    ]) ?>
                                    <?= $this->Html->link(__('Editar'), ['action' => 'edit', $designation->id], [
                                        'escape' => false,
                                        'class' => 'dropdown-item'
                                    ]) ?>
                                    <?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $designation->id], ['class' => 'dropdown-item', 'confirm' => __('Esta seguro que quiere eliminar la capacitación # {0}?', $designation->id)]) ?>
                                </div>
                            </div>
                        </td>
                    </tr>
